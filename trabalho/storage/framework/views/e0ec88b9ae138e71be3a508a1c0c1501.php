...
<?php endif; ?>
			...
			<div class="w-full mt:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
			<?php echo e($slot); ?>

			</div>
		</div>
	</body>
</html><?php /**PATH /home/alisha/myApps/trabalho/resources/views/components/master.blade.php ENDPATH**/ ?>